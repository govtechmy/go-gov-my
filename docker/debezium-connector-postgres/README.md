...
Please note if you want to test against a _non-RDS_ cluster, this test requires `<your user>` to be a superuser with not only `replication` but permissions
