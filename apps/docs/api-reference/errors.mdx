---
title: "Errors"
"og:title": "GoGovMy API returns machine readable error codes, human readable error messages and a link to the docs for more information"
description: "Troubleshoot problems with this comprehensive breakdown of all error codes."
---

GoGovMy API returns machine readable error codes, human readable error messages and a link to the docs for more information.
...
Here is a list of all error codes GoGovMy API returns:
