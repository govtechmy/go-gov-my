...
GoGovMy's codebase is set up in a monorepo (via [Turborepo](https://turbo.build/repo)) and is fully [open-source on GitHub](https://github.com/dubinc/dub).
...
- `web`: The entirety of GoGovMy's application ([app.dub.co](https://app.dub.co)) + our link redirect infrastructure.
- `docs`: GoGovMy's documentation site ([dub.co/docs](https://dub.co/docs)) – including this page you're on right now!
