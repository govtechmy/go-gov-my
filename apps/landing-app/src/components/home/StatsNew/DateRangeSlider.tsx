  ...
  return (
    <div className="w-full px-4 py-6">
      ...
      >
        ...
        >
          {showStartPopover && (
            <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 z-10 whitespace-nowrap px-3 py-2 text-sm text-white bg-gray-900 rounded-lg shadow-sm">
