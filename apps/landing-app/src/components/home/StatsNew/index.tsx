  ...
  return (
    <Section className={cn('col-span-full', 'px-4 md:px-6 lg:px-8', 'overflow-hidden')}>
      <div className="relative w-full">
          ...
          <div>
            <button
              className={cn(
                ...
                selectedView === 'Cumulative' ? 'bg-gray-200' : 'bg-transparent'
              )}
              onClick={() => {
            ...
            <button
              className={cn(
                ...
                selectedView === 'Daily' ? 'bg-gray-200' : 'bg-transparent'
              )}
              onClick={() => {
        ...
        <div className={cn('grid gap-6', 'grid-cols-1', 'md:grid-cols-1', 'lg:grid-cols-3')}>
          {[
