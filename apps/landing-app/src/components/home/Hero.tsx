...
export default function Hero(props: Props) {
  ...
  return (
    ...
    <BorderedSection id={props.id} className={cn('px-0', 'grid grid-cols-12', props.className)}>
      <div
        className={cn(
      ...
      >
        <div className="grid grid-cols-12 lg:flex">
          <Heading
            level={1}
            className={cn('col-start-2 col-end-12', 'text-pretty text-center lg:text-start')}
          >
            {props.titleKey}
          </Heading>
        </div>
        <div className="grid grid-cols-12 lg:flex">
          <Paragraph
            className={cn('col-start-2 col-end-12', 'mt-[1.625rem]', 'text-center lg:text-start')}
          >
        ...
        <Paragraph className="mt-[1.125rem] text-center lg:text-start">{props.signInKey}</Paragraph>
      </div>
      <div
        className={cn(
