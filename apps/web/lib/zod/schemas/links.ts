...
const LinksQuerySchema = z.object({
  ...
  withTags: booleanQuerySchema
    .optional()
    .default('false')
    .describe('Whether to include tags in the response. Defaults to `false` if not provided.'),
});
...
export const domainKeySchema = z.object({
  ...
  // .refine((v) => validDomainRegex.test(v) || v === 'localhost', {
...
export const createLinkBodySchema = z.object({
  ...
  banned: z.boolean().optional().default(false).describe('Whether the short link is banned.'),
  publicStats: z
    .boolean()
    .optional()
    .default(false)
...
export const LinkSchema = z
  .object({
    ...
    domain: z
      .string()
      .describe(
        'The domain of the short link. If not provided, the primary domain for the workspace will be used (or `go.gov.my` if the workspace has no domains).'
      ),
    key: z
      .string()
      .describe(
    ...
    shortLink: z
      ...
      .url()
      .describe(
        'The full URL of the short link, including the https protocol (e.g. `https://go.gov.my/try`).'
      ),
    qrCode: z
      .string()
      .url()
      .describe(
        'The full URL of the QR code for the short link (e.g. `https://api.dub.co/qr?url=https://go.gov.my/try`).'
      ),
