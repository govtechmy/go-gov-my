...
import EncryptedLock from '@/ui/shared/icons/encrypted-lock';
        ...
        <button className="h-[2.25rem] w-full md:h-[1.75rem]" onClick={() => setOpen(!open)}>
          <div className="flex flex-wrap items-center gap-1.5 text-sm/4 text-brand-700 max-sm:justify-between sm:py-1">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-gray-700 font-medium tracking-[0.026em]">
                {props.officialGovWebsiteKey}
              </span>
            </div>
            <div className="flex items-center gap-0.5 max-sm:rounded-md max-sm:bg-outline-200 max-sm:px-1 text-blue-700">
        ...
        <Collapse isOpen={open}>
          <div className="grid grid-cols-1 gap-4.5 pb-6 pt-4.5 sm:grid-cols-2 sm:gap-6 sm:pb-8 sm:pt-6">
            ...
            <div className="flex gap-3">
              <GovMY className="size-[1.5rem] shrink-0 text-gray-500 dark:text-red-500" />
              <div className="space-y-1.5">
                <p className="font-medium font-[570] max-sm:text-sm">{props.officialKey}</p>
            ...
            <div className="flex gap-3">
              <EncryptedLock className="size-[1.5rem] shrink-0 text-gray-500" />
              <div className="space-y-1.5">
