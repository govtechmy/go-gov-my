...
export default function WorkspaceCard({ id, name, slug, logo, usage, plan }: WorkspaceProps) {
  const { data: count } = useSWR<number>(`/api/links/count?workspaceId=${id}`, fetcher);
