  ...
  return (
    ...
    >
      <button
        ...
        className="flex w-full items-center justify-between space-x-2 rounded-md bg-white px-2 py-2 border border-gray-200 shadow transition-all duration-75 hover:shadow-md"
      >
        <IconMenu
