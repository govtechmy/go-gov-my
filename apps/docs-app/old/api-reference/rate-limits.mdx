---
title: "Rate limits"
"og:title": "What are GoGovMy's API rate limits?"
description: "Learn about GoGovMy's API rate limits."
---

GoGovMy's API rate limiting is in conformance with the [IETF standard](https://datatracker.ietf.org/doc/html/draft-ietf-httpapi-ratelimit-headers):
...
GoGovMy's API is capped at **600 requests per minute** per user.
